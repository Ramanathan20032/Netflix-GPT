    ...
    return (
        <>
            <div className="flex flex-wrap gap-4 mb-11">
                {/* Play Trailer Button */}
                <button className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors cursor-pointer transition-all duration-200 flex items-center gap-1.5 group">
                ...
                {/* Add to List Button */}
                <button className="bg-gray-800 bg-opacity-70 hover:bg-gray-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors cursor-pointer transition-all duration-200 flex items-center gap-1.5 group">
